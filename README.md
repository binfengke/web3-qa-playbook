...
|---|----------|-------|------------|
| 01 | [MetaMask Checklist](01-metamask-checklist.md) | Connection, transactions, network switching, error handling | 23 |
...
**Total: 97 test cases** across 6 core Web3 testing areas.
